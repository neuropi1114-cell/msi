...
const teamMembers = [
  ...
  },
  {
    ...
    role: 'Founder',
    image: '/images/aperna-founder.png',
  },
  {
    name: 'Dr. Peter Gseller',
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {teamMembers.map((member, idx) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-4 border border-black/[0.08] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group"
            >
              <div className="space-y-3">
                ...
                <div className="space-y-0.5 pt-1">
                  ...
                  <div className="text-base font-bold text-msi-blue tracking-tight group-hover:text-msi-orange transition-colors leading-snug">
                    {member.name}
                  </div>
                </div>
              </div>
