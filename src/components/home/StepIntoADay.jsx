      ...
      <div className="container mx-auto px-4 md:px-12 grid gap-12 lg:grid-cols-2 items-center">
        ...
        <div className="lg:pl-10">
          <img
            ...
            loading="lazy"
          />
          <p className="text-gray-700 text-lg mb-6 leading-8 text-justify">
          ...
          <p className="text-gray-700 text-lg mb-10 leading-8 text-justify">
          ...
          <a
            href="/nep"
            className="inline-flex items-center justify-center bg-msi-orange text-white font-bold py-4 px-10 rounded-full  text-lg"
          >
            Read More
          </a>
        </div>
