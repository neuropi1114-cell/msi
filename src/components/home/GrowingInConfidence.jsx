    ...
    <div className="mt-24">
      <div className="text-center max-w-4xl mx-auto mb-12">
        ...
        <div className="text-center">
          <a
            href={growing.link}
            className="font-linotte inline-block px-6 py-3 bg-msi-orange text-white rounded-full font-[200] hover:opacity-90 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
          >
            Read More
          </a>
        </div>
