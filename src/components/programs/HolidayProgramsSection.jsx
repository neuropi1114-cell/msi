...
import { holidayProgramsDrawerBody } from '../../app/programs/programsdata';
  ...
  return (
    <div id={id} className="scroll-mt-24">
      <FaqSection
        ...
        readMoreDrawerTitle="HOLIDAY & SUMMER PROGRAMS"
        readMoreDrawerBody={holidayProgramsDrawerBody}
      />
    </div>
  );
}
