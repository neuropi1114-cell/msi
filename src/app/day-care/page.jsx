      ...
      <main>
        ...
        <section className="bg-msi-purple py-20 text-white relative overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 md:px-12 text-center">
            <h1 className="text-4xl md:text-6xl font-schoolbell font-bold mb-4">Day Care</h1>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 md:px-12 text-center">
            <h2 className="text-4xl md:text-5xl font-schoolbell text-msi-purple font-bold mb-6">
              Play, learn and grow with My School ITALY
            </h2>
        ...
        <section className="py-20 bg-[#f7f9fc]">
          <div className="container mx-auto px-4 md:px-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              ...
              <div>
                <h2 className="text-3xl font-schoolbell text-msi-purple font-bold mb-6">Our Great Vision</h2>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 md:px-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div>
                <h2 className="text-3xl font-schoolbell text-msi-purple font-bold mb-6">We make learning magical through creativity</h2>
                <p className="text-gray-600 mb-4 leading-relaxed">
        ...
        <section className="py-16 bg-msi-purple text-white">
          <div className="container mx-auto px-4 md:px-12 flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto">
            <div>
              <h2 className="text-3xl font-schoolbell font-bold mb-2">ENROL YOUR CHILD</h2>
        ...
        <section className="py-20 bg-[#f7f9fc]">
          <div className="container mx-auto px-4 md:px-12 text-center">
            <h2 className="text-3xl font-schoolbell text-msi-purple font-bold mb-2">Recent News</h2>
